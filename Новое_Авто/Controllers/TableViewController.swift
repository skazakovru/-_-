...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        itemArray = ["Документы","Маркировка","Комплектация","Дополнительное оборудование","Внешний осмотр","Колеса","Кузов и его элементы","Уровень технических жидкостей","Осмотр салона","Проверка основных узлов и агрегатов"]
